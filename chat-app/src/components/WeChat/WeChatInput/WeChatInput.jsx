...
//接口组件
import { reqAddChatMessage } from '../../../api/wechatmessage';
...
export default function WeChatInput() {
    ...
    const sendmessage = () => {
        ...
        if (inputvalue !== null && inputvalue !== undefined && inputvalue !== '') {
            ...
            //向后端发送请求
            const addmessage = reqAddChatMessage(user._id, inputvalue, user.avatarImage, user.username);
            //socket发送数据请求
